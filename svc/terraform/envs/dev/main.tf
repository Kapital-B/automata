terraform {
  ...
  backend "s3" {
    bucket         = "automata-dev-terraform-state"
    key            = "automata.tfstate"
    region         = "eu-west-1"
    dynamodb_table = "automata-lock-table"
  }
}
...
locals {
  ...
  hosted_zone_name     = "api.automata-dev.kapital-b.com"
  api_domain_name      = "api.automata-dev.kapital-b.com"
  dashboard_base_url   = "https://automata-dev.kapital-b.com"
  ms_redirect_uri      = "https://api.automata-dev.kapital-b.com/api/accounts/callback"
  ms_auth_redirect_uri = "https://api.automata-dev.kapital-b.com/api/auth/microsoft/callback"
  google_redirect_uri  = "https://api.automata-dev.kapital-b.com/api/auth/google/callback"
  slack_redirect_uri   = "https://api.automata-dev.kapital-b.com/api/connectors/callback"
  cors_origins = [
    "https://automata-dev.kapital-b.com",
    "http://localhost:5173"
  ]
}
...
output "hosted_zone_name_servers" {
  description = "Nameservers to NS-delegate for api.automata-dev.kapital-b.com from the parent kapital-b.com zone."

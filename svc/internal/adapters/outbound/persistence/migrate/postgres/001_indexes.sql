...
CREATE INDEX IF NOT EXISTS idx_messages_account_summary_seen ON messages(account_id, summary_seen_at);
CREATE INDEX IF NOT EXISTS idx_messages_account_forward_seen ON messages(account_id, forward_seen_at);
...
CREATE INDEX IF NOT EXISTS idx_interpretation_sources_connector ON interpretation_sources(connector_message_id);
...
CREATE INDEX IF NOT EXISTS idx_connector_messages_project_occurred ON connector_messages(project_id, occurred_at);
CREATE INDEX IF NOT EXISTS idx_connector_messages_account ON connector_messages(connector_account_id);
